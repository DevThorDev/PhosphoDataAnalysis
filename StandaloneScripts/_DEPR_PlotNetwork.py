...
nmDatF = 'Corr__BinOp_MetD_GT0_AllD_PhoD_GT0_AllD__IdxPosCI_gr8_SD2_gr8'
...
if sTask in ['Idx_gr8_SD2_gr8_GT0', 'Idx_gr8_SD2_gr8_GT1',
    ...
    if sTask == 'Idx_gr8_SD2_gr8_GT0':
        ...
        nmDatF = 'Corr__BinOp_MetD_GT1_AllD_PhoD_GT1_AllD__IdxPosCI_gr8_SD2_gr8'
    elif sTask == 'Idx_gr8_SD2_gr8_GT2':
        nmDatF = 'Corr__BinOp_MetD_GT2_AllD_PhoD_GT2_AllD__IdxPosCI_gr8_SD2_gr8'
    elif sTask == 'Idx_gr8_SD2_gr8_GT3':
        nmDatF = 'Corr__BinOp_MetD_GT3_AllD_PhoD_GT3_AllD__IdxPosCI_gr8_SD2_gr8'
    elif sTask == 'Idx_gr8_SD2_gr8_GT4':
        nmDatF = 'Corr__BinOp_MetD_GT4_AllD_PhoD_GT4_AllD__IdxPosCI_gr8_SD2_gr8'
    elif sTask == 'Idx_gr8_SD2_gr8_GT5':
        nmDatF = 'Corr__BinOp_MetD_GT5_AllD_PhoD_GT5_AllD__IdxPosCI_gr8_SD2_gr8'
    elif sTask == 'SRR_AllGT_Idx_gr8':
        nmDatF = 'StronglyReducedResults_CorrDevClust_AllGT_NoMalt__SortIdxPosCI'
    ...
    if sTask in lTaskAvgMaxGT0:
        nmDatF = 'Corr__BinOp_MetD_CI_GT0_AllD_PhoD_CI_GT0_AllD'
    elif sTask in lTaskAvgMaxGT1:
        nmDatF = 'Corr__BinOp_MetD_CI_GT1_AllD_PhoD_CI_GT1_AllD'
    elif sTask in lTaskAvgMaxGT5:
        nmDatF = 'Corr__BinOp_MetD_CI_GT5_AllD_PhoD_CI_GT5_AllD'
