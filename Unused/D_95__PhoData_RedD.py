...
# --- general -----------------------------------------------------------------
strOType = 'Phospho data set, reduced to bin1_new values in [30]'
strNmSpec = 'PhoData_RedD'
strNmMut = 'WT'
...
nDF_noX = 'PhosphoData_log2_Intensitites_WT_RedD_30_ThS'
