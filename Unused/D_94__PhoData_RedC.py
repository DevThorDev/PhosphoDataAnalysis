...
# --- general -----------------------------------------------------------------
strOType = 'Phospho data set, reduced to bin1_new values in [4]'
strNmSpec = 'PhoData_RedC'
strNmMut = 'WT'
...
nDF_noX = 'PhosphoData_log2_Intensitites_WT_RedC_4_ThS'
