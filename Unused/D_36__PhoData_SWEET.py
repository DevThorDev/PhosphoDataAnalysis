...
# --- data specific -----------------------------------------------------------
cSep = ';'
lCat = ['DR-SWEET', 'DS-SWEET', 'NR-SWEET', 'NS-SWEET']
...
nmDF_noX = 'Phosphopeptides_log2_lfq_SWEET_ThS'
...
pRelResF = os.path.join('..', '..', '12_SysBio02_DataAnalysis',
                        '21_Results__36__PhoData_SWEET')
pRelPltF = os.path.join('..', '..', '12_SysBio02_DataAnalysis',
                        '41_Figures__36__PhoData_SWEET')
