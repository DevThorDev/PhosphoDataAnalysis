...
# --- data specific -----------------------------------------------------------
cSep = ';'
lCat = ['DR-SIRK1-PGM', 'DS-SIRK1-PGM', 'NR-SIRK1-PGM', 'NS-SIRK1-PGM']
...
nmDF_noX = 'Phosphopeptides_log2_lfq_SIRK1-PGM_ThS'
...
pRelResF = os.path.join('..', '..', '12_SysBio02_DataAnalysis',
                        '21_Results__34__PhoData_SIRK1-PGM')
pRelPltF = os.path.join('..', '..', '12_SysBio02_DataAnalysis',
                        '41_Figures__34__PhoData_SIRK1-PGM')
