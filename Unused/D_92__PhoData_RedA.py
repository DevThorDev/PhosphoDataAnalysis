...
# --- general -----------------------------------------------------------------
strOType = 'Phospho data set, reduced to bin1_new values in [2, 4, 30, 34]'
strNmSpec = 'PhoData_RedA'
strNmMut = 'WT'
...
nDF_noX = 'PhosphoData_log2_Intensitites_WT_RedA_2_4_30_34_ThS'
