...
# --- general -----------------------------------------------------------------
strOType = 'Phospho data set, reduced to bin1_new values in [34]'
strNmSpec = 'PhoData_RedE'
strNmMut = 'WT'
...
nDF_noX = 'PhosphoData_log2_Intensitites_WT_RedE_34_ThS'
