...
# --- general -----------------------------------------------------------------
strOType = 'Phospho data set, reduced to bin1_new values in [2]'
strNmSpec = 'PhoData_RedB'
strNmMut = 'WT'
...
nDF_noX = 'PhosphoData_log2_Intensitites_WT_RedB_2_ThS'
