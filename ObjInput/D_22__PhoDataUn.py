...
# --- general -----------------------------------------------------------------
sOType = 'Phosphopeptide data set (untransformed)'
sNmSpec = GC.S_PHO_D_L + GC.S_UN
...
dNCl4Corr = {(GC.NM_XFEAT_C, None): [10],
             (GC.NM_XFEAT_G, None): [10],
             (GC.NM_XFEAT_C, GC.NM_TYPEX_S): [10],
             (GC.NM_XFEAT_C, GC.NM_TYPEX_F): [10],
             (GC.NM_XFEAT_G, GC.NM_TYPEX_S): [10],
             (GC.NM_XFEAT_G, GC.NM_TYPEX_F): [10]}
distThrAgglo = None
...
dISPr = {'No': {0: '', 4: '_', 6: '_'},
         'Tr': {0: '', 1: '_', 4: '_', 6: '_'},
         'Dv': {0: '', 1: '_', 4: '_', 6: '_'}}
nmDFPre = 'Phosphopeptide_unTr_OutlMedian5p0'
